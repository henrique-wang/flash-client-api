...
class EditCartPage2(Frame):
    def __init__(self, parent, controller):
        self.controller = controller
        Frame.__init__(self, parent, bg=BRANCO)

        self.label = Label(self, text="Editar produto", font=LARGE_FONT, bg=BRANCO, relief="groove")
        ...
        self.quantity.insert(0, controller.update_product.getQuantity())
        ...
        self.quantity.place(relx=0.52, rely=0.35, anchor='center')
    ...
    def editInfo(self, controller):
        new_product_info = Item(controller.update_product.getName(), self.quantity.get(), 0)
        controller.cart.editItem(new_product_info)
